...
const UsageTrack = () => {
    ...
    const onCheckOut = async (price: number, buttonId: number) => {
        if (!user?.id) {
            router.push("/login");
        }
        ...
        try {
            ...
            if (!response.ok) {
                ...
                console.log('Error while payment:- ', errorData.error);
                return;
            }
                    ...
                    <DialogHeader>
                        ...
                        <DialogDescription className='grid grid-cols-3 justify-between'>
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.basic, 1)} disabled={!!submitting}>
                                    {submitting === 1 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$0.50</p>
                            ...
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.basic2, 2)} disabled={!!submitting}>
                                    {submitting === 2 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$0.80</p>
                            ...
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.medium, 3)} disabled={!!submitting}>
                                    {submitting === 3 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$1.39</p>
                            ...
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.medium2, 4)} disabled={!!submitting}>
                                    {submitting === 4 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$2.30</p>
                            ...
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.large, 5)} disabled={!!submitting}>
                                    {submitting === 5 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$3.46</p>
                            ...
                            <Card className='h-40 w-32 mb-2'>
                                ...
                                <Button className='w-full h-6' variant="secondary" onClick={() => onCheckOut(price.premium, 6)} disabled={!!submitting}>
                                    {submitting === 6 ? (
                                        <Spinner />
                                    ) : (
                                        <p>$4.33</p>
